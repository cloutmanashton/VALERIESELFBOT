...
class malicious(commands.Cog):
    ...
    async def bin(self, ctx, message):
        ...
        embed.set_footer(text="Quite possibly the shittest selfbot made by Vice#1337")
    ...
    async def ip(self, ctx, message):
        ...
        if sts == "fail":
            ...
            embed.set_footer(
                text="Quite possibly the shittest selfbot made by Vice#1337"
            )
...
Quite possibly the shittest selfbot made by Vice#1337```"""
                )
